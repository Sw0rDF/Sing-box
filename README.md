...
```
bash <(curl -Ls https://raw.githubusercontent.com/Sw0rDF/sing-box/main/sb_serv00.sh)
```
...
```
VMESS_PORT=tcp端口 HY2_PORT=udp端口 TUIC_PORT=udp端口 bash <(curl -Ls https://raw.githubusercontent.com/Sw0rDF/sing-box/main/sb_00.sh)
```
